...
> A fork of [ent/ent](https://github.com/ent/ent), modified throughout. See
> [UPSTREAM.md](UPSTREAM.md) for what differs and why, and [NOTICE](NOTICE) for
> the attribution the Apache 2.0 license asks a fork to carry.
...
- **Multi Storage Driver** - supports MySQL, MariaDB, TiDB, PostgreSQL, CockroachDB and SQLite.
- **Extendable** - simple to extend and customize using Go templates.

## Quick Installation
```console
go install github.com/protobuf-orm/ent/cmd/ent@latest
```
