...
//go:generate go run -mod=mod github.com/protobuf-orm/ent/cmd/ent generate --feature privacy ./schema
```
...
```go
//go:generate go run -mod=mod github.com/protobuf-orm/ent/cmd/ent generate --feature privacy,schema/snapshot ./schema
```
