...
However, all builder types implement the generic <a target="_blank" href="https://pkg.go.dev/github.com/protobuf-orm/ent?tab=doc#Mutation">`ent.Mutation`</a> interface.
