...
## Set up the Atlas CLI

This feature is planned and applied by the Atlas CLI, not by Ent, and it needs an Atlas Cloud account. Install the
CLI and run `atlas login` as described at [atlasgo.io](https://atlasgo.io/getting-started) before continuing.
